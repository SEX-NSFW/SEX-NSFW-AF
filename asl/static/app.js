const I18N = {
  ar: {
    ...
    ageText: "هذا الموقع مخصص للمحتوى الإباحي التجاري للبالغين فقط. يجب أن يكون عمرك 18 سنة أو أكثر للمتابعة.",
    ageYes: "أنا 18+",
    ageNo: "خروج",
    noCover: "لم يتم العثور على غلاف ترويجي رسمي. لم يتم عرض أي لقطة داخلية.",
    studio: "الموقع المنتج",
    realTitle: "العنوان الحقيقي",
    performers: "أسماء الممثلين",
    categories: "الفئات",
    summary: "الملخص الرسمي",
    duration: "المدة",
    ...
    low: "منخفضة",
    copied: "تم النسخ!",
    errorGeneric: "حدث خطأ أثناء البحث. حاول مرة أخرى.",
  ...
  en: {
    ...
    search: "Search",
    stage1: "Reading query / pirate page",
    stage2: "Matching studio + cast on IAFD",
    stage3: "Fetching official synopsis",
    stage4: "Fetching promotional cover (not internal stills)",
    copy: "Copy",
    download: "Download",
    history: "Recent searches",
    footer: "Asl · Official promotional covers only · 18+",
    ageTitle: "Age Confirmation",
    ageText: "This site is for commercial adult content only. You must be 18 or older to continue.",
    ageYes: "I am 18+",
    ageNo: "Leave",
  ...
  fr: {
    tagline: "Du nom à la couverture officielle",
    placeholder: "Titre de scène, titre pirate ou URL...",
    search: "Rechercher",
    stage1: "Lecture de la requête / page pirate",
    stage2: "Correspondance studio + distribution sur IAFD",
    stage3: "Récupération du synopsis officiel",
    ...
    ageText: "Ce site est réservé au contenu adulte commercial. Vous devez avoir 18 ans ou plus.",
    ageYes: "J'ai 18+",
    ageNo: "Quitter",
    noCover: "Aucune couverture promotionnelle officielle trouvée.",
    studio: "Studio",
    realTitle: "Titre officiel",
    performers: "Interprètes",
    categories: "Catégories",
    summary: "Synopsis officiel",
    duration: "Durée",
    ...
    low: "Faible",
    copied: "Copié !",
    errorGeneric: "Échec de la recherche.",
    refuseMinor: "Refusé : contenu suggérant un mineur.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  es: {
    tagline: "Del nombre a la portada oficial",
    placeholder: "Nombre de escena, título pirata o URL...",
    search: "Buscar",
    stage1: "Leyendo consulta / página pirata",
    stage2: "Emparejando estudio + elenco en IAFD",
    stage3: "Obteniendo sinopsis oficial",
    stage4: "Obteniendo portada promocional",
    copy: "Copiar",
    download: "Descargar",
    history: "Búsquedas recientes",
    footer: "Asl · Solo portadas promocionales oficiales · 18+",
    ageTitle: "Confirmación de edad",
    ageText: "Este sitio es solo para contenido adulto comercial. Debes tener 18 años o más.",
    ageYes: "Tengo 18+",
    ageNo: "Salir",
    noCover: "No se encontró portada promocional oficial.",
    studio: "Estudio",
    realTitle: "Título oficial",
    performers: "Intérpretes",
    categories: "Categorías",
    summary: "Sinopsis oficial",
    duration: "Duración",
    ...
    low: "Baja",
    copied: "¡Copiado!",
    errorGeneric: "Error en la búsqueda.",
    refuseMinor: "Rechazado: posible menor.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  pt: {
    tagline: "Do nome à capa oficial",
    placeholder: "Nome da cena, título pirata ou URL...",
    search: "Pesquisar",
    stage1: "Lendo consulta / página pirata",
    stage2: "Combinando estúdio + elenco no IAFD",
    stage3: "Buscando sinopse oficial",
    stage4: "Buscando capa promocional",
    copy: "Copiar",
    download: "Baixar",
    history: "Pesquisas recentes",
    footer: "Asl · Apenas capas promocionais oficiais · 18+",
    ageTitle: "Confirmação de idade",
    ageText: "Este site é apenas para conteúdo adulto comercial. Você deve ter 18 anos ou mais.",
    ageYes: "Tenho 18+",
    ageNo: "Sair",
    ...
    low: "Baixa",
    copied: "Copiado!",
    errorGeneric: "Falha na pesquisa.",
    refuseMinor: "Recusado: conteúdo de menor.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  de: {
    tagline: "Vom Namen zum offiziellen Cover",
    placeholder: "Szenenname, Pirate-Titel oder URL...",
    search: "Suchen",
    stage1: "Abfrage / Pirate-Seite lesen",
    stage2: "Studio + Cast auf IAFD abgleichen",
    stage3: "Offizielle Synopsis holen",
    stage4: "Werbe-Cover holen (keine Stills)",
    copy: "Kopieren",
    download: "Download",
    history: "Letzte Suchen",
    footer: "Asl · Nur offizielle Werbe-Cover · 18+",
    ageTitle: "Altersbestätigung",
    ageText: "Diese Seite ist nur für kommerziellen Erwachseneninhalt. Du musst 18+ sein.",
    ageYes: "Ich bin 18+",
    ageNo: "Verlassen",
    noCover: "Kein offizielles Werbe-Cover gefunden.",
    studio: "Studio",
    realTitle: "Offizieller Titel",
    performers: "Darsteller",
    categories: "Kategorien",
    summary: "Offizielle Synopsis",
    duration: "Dauer",
    ...
    refuseMinor: "Abgelehnt: möglicher Minderjähriger.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  ru: {
    tagline: "От названия к официальной обложке",
    placeholder: "Название сцены, пиратское название или URL...",
    search: "Поиск",
    stage1: "Чтение запроса / пиратской страницы",
    stage2: "Сопоставление студии и актёров на IAFD",
    stage3: "Получение официального синопсиса",
    stage4: "Получение промо-обложки",
    copy: "Копировать",
    download: "Скачать",
    history: "Недавние поиски",
    footer: "Asl · Только официальные промо-обложки · 18+",
    ageTitle: "Подтверждение возраста",
    ageText: "Этот сайт только для коммерческого контента 18+. Вам должно быть 18 или больше.",
    ageYes: "Мне 18+",
    ageNo: "Выйти",
    noCover: "Официальная промо-обложка не найдена.",
    studio: "Студия",
    realTitle: "Официальное название",
    performers: "Актёры",
    categories: "Категории",
    summary: "Официальный синопсис",
    ...
    refuseMinor: "Отклонено: возможный несовершеннолетний.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  tr: {
    tagline: "İsimden resmi kapağa",
    placeholder: "Sahne adı, korsan başlık veya URL...",
    search: "Ara",
    stage1: "Sorgu / korsan sayfa okunuyor",
    stage2: "Stüdyo + kadro IAFD eşleştirmesi",
    stage3: "Resmi özet alınıyor",
    stage4: "Promosyon kapağı alınıyor",
    copy: "Kopyala",
    download: "İndir",
    history: "Son aramalar",
    footer: "Asl · Yalnızca resmi promosyon kapakları · 18+",
    ageTitle: "Yaş onayı",
    ageText: "Bu site yalnızca ticari yetişkin içeriği içindir. 18 yaşında veya daha büyük olmalısınız.",
    ageYes: "18+ yaşındayım",
    ageNo: "Çık",
    noCover: "Resmi promosyon kapağı bulunamadı.",
    studio: "Stüdyo",
    realTitle: "Resmi başlık",
    performers: "Oyuncular",
    categories: "Kategoriler",
    summary: "Resmi özet",
    duration: "Süre",
    release: "Yayın tarihi",
    officialLink: "Resmi bağlantı",
    confidence: "Güven",
    high: "Yüksek",
    medium: "Orta",
    low: "Düşük",
    copied: "Kopyalandı!",
    errorGeneric: "Arama başarısız.",
    refuseMinor: "Reddedildi: reşit olmayan içeriği.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  hi: {
    tagline: "नाम से आधिकारिक कवर तक",
    placeholder: "दृश्य का नाम, पाइरेट शीर्षक या URL...",
    search: "खोजें",
    stage1: "क्वेरी / पाइरेट पेज पढ़ना",
    stage2: "IAFD पर स्टूडियो + कास्ट मिलान",
    stage3: "आधिकारिक सारांश लाना",
    stage4: "प्रचार कवर लाना",
    copy: "कॉपी",
    download: "डाउनलोड",
    history: "हाल की खोजें",
    footer: "Asl · केवल आधिकारिक प्रचार कवर · 18+",
    ageTitle: "आयु पुष्टि",
    ageText: "यह साइट केवल व्यावसायिक वयस्क सामग्री के लिए है। आपको 18 या अधिक होना चाहिए।",
    ageYes: "मैं 18+",
    ageNo: "बाहर निकलें",
    noCover: "कोई आधिकारिक प्रचार कवर नहीं मिला।",
    studio: "स्टूडियो",
    realTitle: "आधिकारिक शीर्षक",
    performers: "कलाकार",
    categories: "श्रेणियाँ",
    summary: "आधिकारिक सारांश",
    duration: "अवधि",
    release: "रिलीज़ तिथि",
    ...
    low: "निम्न",
    copied: "कॉपी हो गया!",
    errorGeneric: "खोज विफल।",
    refuseMinor: "अस्वीकृत: नाबालिग सामग्री।",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  id: {
    tagline: "Dari nama ke sampul resmi",
    placeholder: "Nama adegan, judul bajak laut, atau URL...",
    search: "Cari",
    stage1: "Membaca kueri / halaman bajak laut",
    stage2: "Mencocokkan studio + pemain di IAFD",
    stage3: "Mengambil sinopsis resmi",
    stage4: "Mengambil sampul promosi",
    copy: "Salin",
    download: "Unduh",
    history: "Pencarian terbaru",
    footer: "Asl · Hanya sampul promosi resmi · 18+",
    ageTitle: "Konfirmasi usia",
    ageText: "Situs ini hanya untuk konten dewasa komersial. Anda harus berusia 18 tahun atau lebih.",
    ageYes: "Saya 18+",
    ageNo: "Keluar",
    noCover: "Sampul promosi resmi tidak ditemukan.",
    studio: "Studio",
    realTitle: "Judul resmi",
    performers: "Pemain",
    categories: "Kategori",
    summary: "Sinopsis resmi",
    duration: "Durasi",
    release: "Tanggal rilis",
    officialLink: "Tautan resmi",
    confidence: "Kepercayaan",
    high: "Tinggi",
    medium: "Sedang",
    low: "Rendah",
    copied: "Disalin!",
    errorGeneric: "Pencarian gagal.",
    refuseMinor: "Ditolak: konten di bawah umur.",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  ja: {
    tagline: "名前から公式カバーへ",
    placeholder: "シーン名、海賊版タイトル、またはURL...",
    search: "検索",
    stage1: "クエリ / 海賊ページを読み取り中",
    stage2: "IAFDでスタジオ＋キャスト照合",
    stage3: "公式あらすじを取得",
    stage4: "プロモカバーを取得",
    copy: "コピー",
    download: "ダウンロード",
    ...
    ageTitle: "年齢確認",
    ageText: "このサイトは商業アダルトコンテンツ専用です。18歳以上である必要があります。",
    ageYes: "私は18+",
    ageNo: "退出",
    ...
    low: "低",
    copied: "コピーしました！",
    errorGeneric: "検索に失敗しました。",
    refuseMinor: "拒否：未成年の可能性があります。",
    example1: "Family Vacation!!! Family Strokes",
    example2: "It Just Slipped In S2:E8",
    example3: "Ill Show You What Girls Want S21:E1",
  },
  ko: {
    tagline: "이름에서 공식 커버로",
    placeholder: "장면 이름, 해적 제목 또는 URL...",
    search: "검색",
    stage1: "쿼리 / 해적 페이지 읽기",
    stage2: "IAFD에서 스튜디오 + 출연진 매칭",
    stage3: "공식 시놉시스 가져오기",
    stage4: "프로모 커버 가져오기",
    copy: "복사",
    download: "다운로드",
    ...
    ageTitle: "나이 확인",
    ageText: "이 사이트는 상업용 성인 콘텐츠 전용입니다. 18세 이상이어야 합니다.",
    ageYes: "나는 18+",
    ageNo: "나가기",
  ...
  zh: {
    tagline: "从名称到官方封面",
    placeholder: "场景名称、盗版标题或URL...",
    search: "搜索",
    stage1: "读取查询 / 盗版页面",
    stage2: "在IAFD匹配工作室和演员",
    stage3: "获取官方简介",
    stage4: "获取宣传封面",
    copy: "复制",
    download: "下载",
...
async function doSearch() {
  ...
  try {
    ...
    if (data.error) {
      document.getElementById("error-msg").textContent = data.error || t("errorGeneric");
      document.getElementById("error-box").classList.add("show");
      return;
    }
    ...
    showStages(false);
    document.getElementById("search-btn").disabled = false;
    document.getElementById("error-msg").textContent = t("errorGeneric");
    document.getElementById("error-box").classList.add("show");
  }
}
