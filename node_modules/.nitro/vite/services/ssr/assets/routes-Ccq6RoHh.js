...
import { Check, Clapperboard, Copy, ImageOff, Loader2, Search } from "lucide-react";
...
var Input = React.forwardRef(({ className, type = "text", ...props }, ref) => {
...
//#endregion
//#region src/components/scene-cover-app.tsx
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx(Input, {
								...
								children: [loading ? /* @__PURE__ */ jsx(Loader2, { className: "animate-spin" }) : /* @__PURE__ */ jsx(Search, {}), t.search]
							})]
						}),
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs(Button, {
								...
								disabled: loading,
								children: [/* @__PURE__ */ jsx(Clapperboard, {}), t.demo]
							})
						})
					]
				}),
				...
				/* @__PURE__ */ jsx("main", {
					...
					children: loading ? /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsx(Loader2, { className: "size-8 animate-spin text-muted" })
						}), /* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "h-4 w-2/3 rounded-sm bg-surface-2" }),
								/* @__PURE__ */ jsx("div", { className: "h-4 w-1/3 rounded-sm bg-surface-2" })
							]
						})]
					}) : result?.coverUrl ? /* @__PURE__ */ jsxs("article", {
						className: "overflow-hidden rounded-xl border border-border bg-surface",
						children: [/* @__PURE__ */ jsx("div", {
							className: "relative bg-surface-2",
							children: displaySrc && !imageFailed ? /* @__PURE__ */ jsx("img", {
								src: displaySrc,
								alt: result.title ?? "",
								...
								children: [/* @__PURE__ */ jsx(ImageOff, { className: "size-8" }), /* @__PURE__ */ jsx("p", {
									className: "text-sm",
							...
							children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
								...
								children: [
									result.studio ? /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
									...
									result.source ? /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("dt", {
										className: "text-subtle",
										children: t.source
									}), /* @__PURE__ */ jsx("dd", {
										className: "text-fg",
									...
									result.performers.length ? /* @__PURE__ */ jsxs("div", {
										className: "min-w-0",
							...
							})] }), imageReady && result.coverUrl ? /* @__PURE__ */ jsxs("div", {
								...
								children: [
									...
									/* @__PURE__ */ jsxs(Button, {
										...
										children: [copied ? /* @__PURE__ */ jsx(Check, {}) : /* @__PURE__ */ jsx(Copy, {}), copied ? t.copied : t.copy]
									})
								]
							}) : imageFailed ? null : /* @__PURE__ */ jsx("p", {
								className: "text-sm text-muted",
								children: t.searching
							})]
						})]
					}) : result?.error === "invalid_query" ? /* @__PURE__ */ jsx(StateCard, {
						title: t.invalid,
						body: ""
					}) : result?.error === "unverified" ? /* @__PURE__ */ jsx(StateCard, {
						title: t.unverifiedTitle,
						body: t.unverifiedBody
					}) : result?.error === "not_found" ? /* @__PURE__ */ jsx(StateCard, {
						title: t.notFoundTitle,
						body: t.notFoundBody
					}) : /* @__PURE__ */ jsx(StateCard, {
						title: t.emptyTitle,
						body: t.emptyBody,
						quiet: true
					})
...
function Home() {
	return /* @__PURE__ */ jsx(SceneCoverApp, {});
}
//#endregion
